...
export function RoadmapComposer({ onSubmit }: RoadmapComposerProps) {
  ...
  return (
    <div className="flex flex-col gap-3 border-t border-brand-slate-200 dark:border-brand-slate-700 pt-4">
      ...
      <textarea
        ...
        className={
          "w-full resize-y rounded-lg border border-brand-slate-300 dark:border-brand-slate-700 " +
          "bg-white dark:bg-brand-slate-800 px-4 py-3 text-brand-slate-900 dark:text-brand-slate-50 shadow-sm " +
