...
export function HowItWorks() {
  return (
    <section className="border-t border-brand-slate-200 bg-white py-20">
      <div className="mx-auto max-w-5xl px-6">
        ...
        <ol className="mt-12 grid gap-8 sm:grid-cols-3">
          {steps.map((step) => (
            <li
              key={step.number}
              className="rounded-xl border border-brand-slate-200 bg-brand-slate-50 p-6"
            >
              <step.icon
              ...
              <h3 className="mt-2 text-lg font-semibold text-brand-slate-900">
                {step.title}
              </h3>
