...
| ---------------- | ------ | --------- | -------------------------------------------------------------------------------------------------------------------------- |
| gemini-3.6-flash | $7.50  | Low       | New 2026-07-22 on Cursor's pricing page — Google's Gemini 3.6 Flash at $1.50/$7.50 (visible, not hidden); cheaper than 3.5 Flash ($9/M) at the same input price; will be added to `<model-options>` on the selector pass |
