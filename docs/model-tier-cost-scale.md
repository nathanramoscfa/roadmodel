...
| GPT-5.4 Nano       | $0.20 | –           | $0.02      | $1.25  | Low       | Hidden by default; Smallest GPT-5.4 variant, optimized for cost | 
...
<!-- subscription-tiers-reviewed: 2026-07-31 -->
...
| ---------------- | ------ | --------- | -------------------------------------------------------------------------------------------------------------------------- |
| claude-opus-5    | $25.00 | Very High | New 2026-07-31 on Cursor's pricing page — Anthropic's Claude Opus 5 at $5/$25 (mirrors Opus 4.7 / 4.8 pricing); fast mode variant `claude-opus-5-fast` also listed; not yet added to `<model-options>` (selector-pass will handle) |
| kimi-k3          | $15.00 | High      | New 2026-07-31 on Cursor's pricing page — Moonshot's Kimi K3 at $3/$15 with 1M extended-context at same per-token rates; requires Max Mode on legacy request-based plans; not yet added to `<model-options>` (selector-pass will handle) |
| gemini-3.6-flash | $7.50  | Low       | New 2026-07-31 on Cursor's pricing page — Google's Gemini 3.6 Flash at $1.50/$7.50, cheaper than 3.5 Flash ($9) and now visible (not Hidden by default); not yet added to `<model-options>` (selector-pass will handle) |
