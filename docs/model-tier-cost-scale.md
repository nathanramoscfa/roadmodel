...
<!-- subscription-tiers-reviewed: 2026-06-25 -->
...
| ---------------- | ------ | --------- | -------------------------------------------------------------------------------------------------------------------------- |
| glm-5.2          | $4.40  | Low       | New 2026-06-25 in cost-scale — z.ai's GLM 5.2 visible on Cursor pricing page (Hidden by default); provider-direct prices preserved verbatim from `<model-options>` ($1.40 input / $4.40 output match Cursor's listed rates) |
...
| OpenAI (San Francisco, US)    | `us`              | gpt-5.5, gpt-5.4, gpt-5.3-codex, gpt-5.2, gpt-5.1-codex, gpt-5, gpt-5.4-mini, gpt-5.4-nano, gpt-5-mini, gpt-oss-120b, gpt-oss-20b (open-weight, hosted by Groq) |
...
| Mistral (Paris, EU)           | `eu`              | mistral-medium-3.5, mistral-small-4, mistral-large-3, codestral                                                         |
| Groq (Mountain View, US)      | `us`              | host for OpenAI's open-weight gpt-oss-120b, gpt-oss-20b (operator-jurisdiction `us`)                                    |
