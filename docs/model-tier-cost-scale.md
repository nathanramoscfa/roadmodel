...
<!-- subscription-tiers-reviewed: 2026-07-02 -->
...
| ---------------- | ------ | --------- | -------------------------------------------------------------------------------------------------------------------------- |
| claude-sonnet-5  | $15.00 | High      | New 2026-07-02 in cost-scale — Anthropic's Claude Sonnet 5 now visible on Cursor's pricing page at $3/M input / $15/M output; launch promotion of $2/$10 through August 31, 2026; uses an updated tokenizer; `<model-options>` entry pending editorial add on the next selector-pass refresh |
