...
- **Headline benchmarks:** AA Intelligence Index 53.4 (Adaptive Reasoning, Max Effort); AA Coding Index 71.5; τ²-bench retail pass_1 86.2 (legacy submission); Terminal-Bench 2.0 80.5
...
- **Best for:** Anthropic's Sonnet 4.6 successor at the same high-tier pricing — placeholder tier ratings inherited from sonnet-4.6 pending broader benchmark coverage; the $2/$10 launch promotion (through 2026-08-31) plus the updated tokenizer are the headline cost-structure changes to surface, and the AA Intelligence Index 53.4 places Sonnet 5 competitively near Opus 4.7 on general intelligence at Sonnet-tier pricing.
...
- **Headline benchmarks:** AA Intelligence Index 41.9; AA Coding Index 60.8; τ²-bench retail pass_1 90.1; LMArena WebDev Elo 1470.6
- **Pricing notes:** Hidden by default
- **Best for:** Moonshot's Kimi K2.7 Code — a code-specialist Kimi variant at $4.00/M output, superseding Kimi K2.5 in Cursor's pool. Placeholder tier ratings inherited from kimi-k2.5 pending broader benchmark coverage; the AA Coding Index 60.8 and τ²-bench retail 90.1 place it as a competitive low-tier coding option for cost-conscious workloads when the cn jurisdiction is acceptable. Routed via Cursor's pool only — no direct Moonshot access method is currently enumerated in the access-methods block.
...
- **Supports models:** opus-4.8,claude-fable-5,opus-4.7,sonnet-5,sonnet-4.6,claude-4.5-haiku
...
- **Supports models:** opus-4.8,opus-4.7,sonnet-5,sonnet-4.6,claude-4.5-haiku
- **Toggles:** Max Mode — no · Thinking — yes
...
- **Supports models:** opus-4.8,claude-fable-5,opus-4.7,gpt-5.5,sonnet-5,sonnet-4.6,gpt-5.4,gpt-5.3-codex,gpt-5.2,gemini-3.1-pro,gemini-3-pro,gpt-5,gpt-5.1-codex,grok-4.3,claude-4.5-haiku,gpt-5.4-mini,gpt-5.4-nano,composer-2,composer-2.5,gemini-2.5-flash,gemini-3-flash,gemini-3.5-flash,gpt-5-mini,kimi-k2.7-code
...
`, platform (access method)
  ...
  <model-options>
    ...
    <tier cost="high">
      <model id="sonnet-5" name="Sonnet 5"
  ...
  <selection-algorithm>
    ...
    Guardrails:
      ...
      - For PRIMARY = `multimodal`, only consider models with tier-multimodal
        of S or A (currently: gemini-3-flash, gemini-3-pro, gemini-3.1-pro at S; sonnet-4.6, sonnet-5, gpt-5.4, opus-4.7, opus-4.8, gpt-5.5 at A).
