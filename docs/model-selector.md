...
- Claude (Anthropic API, Claude Code, claude.ai): per-session
  ...
  diagnostics in `/status`. None of these releases change the
  effort/thinking surface.
