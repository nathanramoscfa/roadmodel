...
- Claude (Anthropic API, Claude Code, claude.ai): per-session
  ...
  2.1.271–2.1.276 are reliability / bug-fix / plugin-safety /
  LLM-gateway / VS Code / Claude apps / Code Review releases (Remote
  cloud/self-hosted fast mode, `/config` mouse support, per-command
  Bash `allowed_domains`, LLM-gateway request-hint headers via
  ...
  and assorted fixes including a 2.1.276 hotfix for a proxy/gateway
  400 error on the `advisor_20260301` input tag introduced in
  2.1.275) with no changes to the `/effort` vocabulary or
  extended-thinking controls. The `/effort` vocabulary itself is
  unchanged.
...
- **Pricing:** Input $0.25/M · Output $2.00/M
- **Tier ratings:** Coding **A** · Planning **C** · Agentic **C** · Multimodal **D** · Long-context **B** · Knowledge **B** · Speed **S**
- **Headline benchmarks:** Auto-added pending editorial tier review; specific benchmark numbers pending next refresh
