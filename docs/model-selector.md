...
- Claude (Anthropic API, Claude Code, claude.ai): per-session
  ...
  fast mode at $10/$50 per Mtok); 2.1.220 is a bug-fix release with
  no surface-parameter changes.
...
- **Headline benchmarks:** AA Intelligence Index 53.5 (#2); LMArena Text #7 (Elo 1481.9); LMArena WebDev #8 (Elo 1559.5); AA-Omniscience 26.2 (#2)
...
- **Headline benchmarks:** AA Intelligence Index 55.7; HLE 45.7%; Terminal-Bench 2.1 84.6; τ²-bench retail pass_1 94.4%
...
- **Pricing:** Input $5.00/M · Output $25.00/M
- **Tier ratings:** Coding **S** · Planning **S** · Agentic **S** · Multimodal **A** · Long-context **S** · Knowledge **S** · Speed **D**
- **Headline benchmarks:** AA Intelligence Index 60.7 (max); HLE 52.6% (max); Terminal-Bench 2.1 89.1; τ²-bench retail pass_1 pending; LMArena Text #1 (Elo 1511.6)
...
- **Best for:** Anthropic's Claude Opus 5 — the successor to Opus 4.8 at the same very-high tier pricing ($5/$25), leading LMArena Text overall (Elo 1511.6) and Artificial Analysis Intelligence Index (60.7 max) with HLE 52.6% at max effort and Terminal-Bench 2.1 89.1; placeholder tier ratings inherited from Opus 4.8 pending an editorial pass, with tier-agentic and tier-coding both at S consistent with the AA coding index (78) and τ² retail scores. 1M native context; fast mode (`claude-opus-5-fast`) available at premium pricing under Max Mode.
...
- **Headline benchmarks:** AA Intelligence Index 59.9 (#1); HLE 53.3% (#1); Terminal-Bench 2.1 84.6; τ²-bench retail pass_1 98.5%
...
- **Best for:** Anthropic's new top-of-line Fable family flagship (no predecessor) — S-tier across coding, planning, agentic, multimodal, long-context, and knowledge, leading HLE (53.3%) and posting a τ²-bench retail 98.5% pass_1 with state-of-the-art vision and a 1M default context; about 2x the cost of Opus 5 and latency-slow (output ~60 tokens/s), so reserve for the hardest reasoning, agentic, and vision work where maximum capability outweighs cost and speed; security-guardrail trips auto-route to Opus.
...
- **Headline benchmarks:** AA Intelligence Index 54.8 (#1); LMArena Text Elo 1464.9 (#23); HLE 44.3%; AA-Omniscience 20.1 (#3)
...
- **Headline benchmarks:** AA Intelligence Index 58.9 (max) / 57.7 (xhigh); HLE 47.2% (max); Terminal-Bench 2.1 88.0; τ²-bench retail pass_1 85.1%
...
- **Headline benchmarks:** AA Intelligence Index 47.2; LMArena Text Elo 1457.3 (#28); AA-Omniscience 12.4; top-ranked tool-calling on Anthropic lineage
- **Pricing notes:** Hidden by default; Requires Max Mode on legacy request-based plans; Up to 1M tokens with extended context at the same per-token rates (no long-context surcharge)
...
- **Pricing:** Input $3.00/M · Output $15.00/M
- **Tier ratings:** Coding **A** · Planning **A** · Agentic **S** · Multimodal **A** · Long-context **A** · Knowledge **A** · Speed **B**
- **Headline benchmarks:** AA Intelligence Index 53.4 (adaptive max); Terminal-Bench 2.1 80.5; τ²-bench retail pass_1 86.2%; native 1M context
...
- **Headline benchmarks:** AA Intelligence Index 57.1 (max); HLE 44.3%; Terminal-Bench 2.1 85.0; τ²-bench retail pass_1 pending; LMArena WebDev Elo 1681.8 (#2)
...
- **Best for:** Moonshot's Kimi K3 flagship — a near-frontier cn-jurisdiction reasoning / coding model at high-tier pricing ($15/M output), scoring AA Intelligence Index 57.1 (max) and ranking #2 on LMArena WebDev (Elo 1681.8); routed via Cursor's pool only, cn-jurisdiction excluded by the default allowed-jurisdictions list unless the user opts into cn; 1M native context and no cache-write fee make it competitive for long-context coding workloads at the mid-cost tier.
...
- **Headline benchmarks:** AA Intelligence Index 51.4 (#4); LMArena Text Elo 1451.8 (#33); GPT-5.4 (xhigh) Output Speed 155.4 tokens/s; lowest factual error rate among GPT models
...
- **Headline benchmarks:** AA Intelligence Index 55.0 (max); HLE 41.8%; Terminal-Bench 2.1 88.0; Output Speed 134.3 tokens/s
...
- **Best for:** OpenAI's mid-tier GPT-5.6 variant between Sol (flagship) and Luna (mini) at the same high-tier pricing as GPT-5.4 ($15/M output) — Artificial Analysis Intelligence Index 55.0 (max) matches near-frontier reasoning while output speed (~134 tokens/s) is faster than most peers; pick for balanced near-frontier reasoning, agentic execution, and speed when Sol's very-high tier isn't justified but stronger throughput than GPT-5.4 is desired.
...
- **Headline benchmarks:** AA Intelligence Index 46.5 (#3); AA-Omniscience 32.9 (#1); HLE 44.7% (#1); LMArena Text Elo 1479.5 (#10); 1M-token context
- **Pricing notes:** -
...
- **Headline benchmarks:** AA Intelligence Index 50.2 (high reasoning); τ²-bench retail pass_1 45.6 (Gemini 3.5 Flash); Output Speed 220.6 tokens/s
- **Pricing notes:** Hidden by default
...
- **Tier ratings:** Coding **B** · Planning **A** · Agentic **A** · Multimodal **B** · Long-context **B** · Knowledge **A** · Speed **S**
- **Headline benchmarks:** AA Intelligence Index 50.1 (high reasoning); HLE 38.3%; Output Speed 216.1 tokens/s; LMArena Text Elo 1477.5 (#12)
- **Pricing notes:** -
- **Best for:** Google's Gemini 3.6 Flash — successor to Gemini 3.5 Flash at the same input price but a cheaper output price ($7.50/M vs $9/M) with comparable capability (AA Intelligence Index 50.1 vs 50.2) and visible (not Hidden by default) on Cursor's pricing page; placeholder tier ratings inherited from gemini-3.5-flash pending editorial refinement, but should generally supersede 3.5-flash as the cost-efficient default Google Flash pick when both are available.

#### GPT-5.6 Luna — `gpt-5.6-luna`

- **Pricing:** Input $1.00/M · Output $6.00/M
- **Tier ratings:** Coding **B** · Planning **A** · Agentic **A** · Multimodal **B** · Long-context **B** · Knowledge **A** · Speed **S**
- **Headline benchmarks:** AA Intelligence Index 51.2 (max) / 49.1 (xhigh); HLE 37.2% (max); Output Speed 174.2 tokens/s (max) / 174.0 (xhigh)
...
- **Best for:** OpenAI's smallest GPT-5.6 variant at low-tier pricing ($6/M output) — strong AA Intelligence Index (51.2 max) for the price and very high output throughput (~174 tokens/s), positioning it as a cost-efficient near-frontier alternative to Gemini 3.5 Flash on the same tier when GPT-family behavior is preferred; pick when latency and cost dominate but broader reasoning quality than smaller mini/nano variants is required.
...
- **Headline benchmarks:** AA Intelligence Index 53.8 (high); Terminal-Bench 2.1 81.6; τ²-bench banking 32.6%; LMArena Text Elo 1451.5 (#35)
...
- **Headline benchmarks:** AA Intelligence Index 29.6; Output Speed 134.2 tokens/s; AA-Omniscience -4.2; latency leader among Claude family
...
- **Headline benchmarks:** AA Intelligence Index 41.9; τ²-bench retail pass_1 90.1%; LMArena WebDev Elo 1473.1
- **Pricing notes:** Hidden by default
...
- **Pricing notes:** Hidden by default; Smallest GPT-5.4 variant, optimized for cost
...
- **Supports models:** claude-opus-5,opus-4.8,claude-fable-5,opus-4.7,claude-sonnet-5,sonnet-4.6,claude-4.5-haiku
- **Toggles:** Max Mode — no · Thinking — yes
- **Best for:** Default for Claude coding or terminal tasks when a claude.ai Max subscription is active — $0 marginal cost until the Max budget is exhausted, full tool-use surface, runs as a CLI, IDE extension inside Cursor, native VS Code extension, and as of 2.1.170+ also ships Claude Fable 5 (Mythos-class) plus a first-class Claude in Chrome browser-control integration (GA in 2.1.198), with Claude Sonnet 5 now the default model (2.1.197+) at native 1M-token context; as of 2.1.219 Claude Opus 5 ships as the new default Opus (1M context, fast mode at $10/$50 per Mtok; 2.1.220 is a bug-fix release with no surface-parameter changes). Exposes the full `/effort` dial (low/medium/high/xhigh/max — Opus 4.6 and Sonnet 4.6 top out at max with no xhigh step; Opus 5, Opus 4.7, Opus 4.8, Sonnet 5, and Fable 5 expose the full range; effort levels a model does not support fall back to the highest supported level at or below the requested one), the Option+T/Alt+T, `alwaysThinkingEnabled`, and `MAX_THINKING_TOKENS=0` on/off controls (Fable 5 cannot disable extended thinking), plus Ultracode (session-wide xhigh + Dynamic Workflows via `/effort ultracode` or `\
...
- **Supports models:** claude-opus-5,opus-4.8,claude-fable-5,opus-4.7,gpt-5.6-sol,gpt-5.5,claude-sonnet-5,sonnet-4.6,kimi-k3,gpt-5.6-terra,gpt-5.4,gpt-5.3-codex,gpt-5.2,gpt-5.2-codex,gemini-3.1-pro,gemini-3-pro,gpt-5,gpt-5.1-codex-max,gpt-5.1-codex,claude-4.5-haiku,gpt-5.4-mini,gpt-5.4-nano,gemini-3.6-flash,gemini-3.5-flash,gpt-5.6-luna,grok-4.5,kimi-k2.7-code,composer-2.5,gemini-2.5-flash,gemini-3-flash,gpt-5-mini,glm-5.2
...
`, platform (access method)
  ...
  <selection-algorithm>
    ...
    Step 7 — Name a backup model (the BACKUP output field).
      ...
      not change the primary MODEL, MAX MODE, THINKING, or PLATFORM — it is
      advisory.
    ...
    Guardrails:
      ...
      - For PRIMARY = `multimodal`, only consider models with tier-multimodal
        of S or A (currently: gemini-3-flash, gemini-3-pro, gemini-3.1-pro at S; sonnet-4.6, claude-sonnet-5, gpt-5.4, gpt-5.6-terra, opus-4.7, opus-4.8, claude-opus-5, gpt-5.5, gpt-5.6-sol at A).
      ...
      - For PRIMARY = `coding` at S-tier requirement, the candidate set is
        gpt-5.1-codex, gpt-5.1-codex-max, gpt-5.3-codex, gpt-5.2-codex, opus-4.7, opus-4.8, claude-opus-5, gpt-5.5, gpt-5.6-sol; cost tie-breaker favors
