...
- **Tier ratings:** Coding **B** · Planning **A** · Agentic **A** · Multimodal **B** · Long-context **B** · Knowledge **A** · Speed **S**
- **Headline benchmarks:** AA Intelligence Index 50.1 (high reasoning); HLE 38.3%; Output Speed 255.5 tokens/s
- **Pricing notes:** -
- **Best for:** Google's Gemini 3.6 Flash — the Flash-tier successor to Gemini 3.5 Flash at cheaper output pricing ($7.50/M vs 3.5 Flash's $9), placeholder tier ratings inherited from gemini-3.5-flash pending independent editorial validation; Artificial Analysis Intelligence Index 50.1 (high) and ~255 tokens/s output speed keep it competitive with 3.5 Flash on capability while undercutting on cost, making it the preferred Gemini Flash pick when both are available.
