...
- Claude (Anthropic API, Claude Code, claude.ai): per-session
  ...
  no surface-parameter changes; 2.1.221 adds a VSCode Focus view
  and sandbox credential-file `mode: "mask"` but no changes to the
  effort/thinking dial.
