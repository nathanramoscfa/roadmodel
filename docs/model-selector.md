...
- Claude (Anthropic API, Claude Code, claude.ai): per-session
  ...
  ships Claude Opus 5 as the default Opus model (1M context, fast
  mode at $10/$50 per Mtok).
...
- **Pricing:** Input $5.00/M · Output $25.00/M
- **Tier ratings:** Coding **S** · Planning **S** · Agentic **S** · Multimodal **A** · Long-context **S** · Knowledge **S** · Speed **D**
- **Headline benchmarks:** AA Intelligence Index 60.7 (max); HLE 52.6% (max); Terminal-Bench 2.1 89.1%; τ²-bench retail pass_1 not yet published for this model
...
- **Best for:** Anthropic's new Claude Opus 5 flagship at the same very-high tier pricing as Opus 4.8 ($5/$25) — placeholder tier ratings inherited from opus-4.8 pending independent Opus 5 vs Opus 4.8 head-to-head; ships as the default Opus model in Claude Code 2.1.219+ with native 1M context and fast mode; Artificial Analysis Intelligence Index 60.7 (max) leads the Opus lineage, so the natural editorial pick when the strongest Anthropic non-Fable frontier reasoning is needed.
...
- **Tier ratings:** Coding **B** · Planning **A** · Agentic **A** · Multimodal **B** · Long-context **B** · Knowledge **A** · Speed **S**
- **Headline benchmarks:** AA Intelligence Index 50.1 (high); Terminal-Bench 2.1 77.5%; τ²-bench banking 24.5%; Output Speed 219.4 tokens/s
- **Pricing notes:** -
- **Best for:** Google's Gemini 3.6 Flash — successor to gemini-3.5-flash at a lower output price ($7.50/M vs $9.00/M) with placeholder tier ratings inherited from the 3.5 Flash predecessor; matches 3.5 Flash's near-frontier Artificial Analysis Intelligence Index (50.1) and adds Terminal-Bench 2.1 77.5%, making it the natural cost-efficient upgrade in the Gemini Flash line pending editorial refinement.
